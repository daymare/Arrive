...
namespace ArriveClient {
	...
	private: RecordViewControl^ recordView;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->updateButton->Click += gcnew System::EventHandler(this, &MainView::updateButton_Click);
			// 
			// logoutButton
			// 
...
#pragma endregion
	...
	private: System::Void MainView_Load(System::Object^  sender, System::EventArgs^  e) {
		this->recordView = gcnew RecordViewControl();
		this->viewPanel->Controls->Add(this->recordView);
		this->update();
	}
